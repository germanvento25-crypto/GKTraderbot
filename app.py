...
input,select{width:100%;padding:12px;border:none;border-radius:10px;margin-top:8px;margin-bottom:18px;background:#334155;color:white;font-size:15px;}
...
.info-box{background:#0f172a;border:1px solid #334155;border-radius:12px;padding:14px;color:#cbd5e1;margin-bottom:18px;}
</style>
</head>
...
<button class="btn-start">Guardar Configuración</button>
